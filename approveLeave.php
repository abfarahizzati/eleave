<html>
<head>
<h1 style="border:4px solid black;  background: linear-gradient(to bottom, #00ffff 0%, #ffffcc 120%);text-align: center;">Approve Leave</h1>
<hr />
</head>
<body>
...
<?php
include 'session.php';
$sql = "SELECT * FROM apply WHERE status = 'approved'";
echo "<br>";
...
} else{ echo "<b><font color='Red'>No Approve Leave for Staff</font></b>";}
mysqli_close($conn);
