	...
	<center><h1><strong>GET STARTED</h1></strong><br></center>
      <div align = "center">
         <div style = "width:300px; border: solid 1px #333333; " align = "left">
            <div style = "background-color:#333333; color:#FFFFFF; padding:3px;"><center><b>Staff Login</b></center></div>
            ...
            <div style = "margin:30px">
               <form action = "" method = "post">
                  ...
                  <center><u><p span class="dot" onclick="location.href ='forgotPassword.php'" style="font-family: 'Montserrat', sans-serif" >Forgot Password</p></u></center>
               </div>
